...
public class extractDataArcheologicalPlace implements Filter<Elements,List<CulturalPlace>> {
    private final Elements elements;

    public extractDataArcheologicalPlace(Elements elements) {
    ...
    public List<CulturalPlace> execute(Elements input) throws IOException {
        ...
        for (Element element : elements) {
            ...
            places.add(new CulturalPlace(name,category,phoneNumber,location));
        }
